...
export const QUERY_SYSTEM_PROMPT = [
  ...
  "",
  "RULES",
  "- category, project and person MUST be a `value` copied exactly from the OPTIONS below, or the string \"all\", or null. Never invent one, never use a display name where a value is given, and never guess at a person who is not listed.",
  "- If the question names somebody or something you cannot find in OPTIONS, set that field to null and say so in `interpretation`. Do not substitute the nearest match.",
