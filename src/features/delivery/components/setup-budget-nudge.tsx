...
// -------------------------------------------------------------------
// "HOW MUCH OF THE BUDGET HAS BEEN ASSIGNED TO TASKS" - the setup nudge.
//
...
// project's budget groups - the thing this screen sets - and the assigned
// figure is the total of every task estimate on the project, which is what
// `ProjectDetailDTO.rollup.budgetMinutes` holds. So the bar reads "of the
// hours you have budgeted, this much is already committed to tasks", which
// is the question somebody setting a project up is answering.
//
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          How much of this project&apos;s budgeted hours is already committed to tasks. This panel is a nudge while
          the project is being set up: it goes once the budget has been assigned, and does not come back if an
          estimate is reduced later.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        {budgetMinutes === 0 ? (
          ...
          <p className="text-sm text-muted-foreground">
            No hours have been budgeted yet. Add a budget group below and give it a pool of hours, and this shows
            how much of it the tasks on the board have already taken.
            {assignedMinutes > 0 &&
