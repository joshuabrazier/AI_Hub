...
import { type UserRole } from "../data/kysely-database-types";
...
// Answers "what role is the caller", and nothing about scope.
//
// A ROLE IS NOT A COMPLETE AUTHORIZATION ANSWER on its own, and this file
// used to carry team guards saying so. Teams are gone, but the rule survives
// them: the things worth scoping are scoped by something nearer the data -
// a project by `project_members`, somebody's chat, time and transcripts by
// the session user id. Reach for the guard the feature owns; this one only
// says who is asking.
// -------------------------------------------------------------------
