...
const clientEnvSchema = z.object({
  ...
  // The IANA timezone the app's calendar dates and session times are read in.
  // Optional with a default so an existing deployment keeps working, but set it
  // deliberately per project - see src/lib/timezone.ts for why it matters.
